...
\hypertarget{md_README}{}\label{md_README}\index{LoRa-\/BLE-\/Sensor@{LoRa-\/BLE-\/Sensor}}
\label{md_README_autotoc_md0}%
\Hypertarget{md_README_autotoc_md0}%
Hardware\+: Lo\+Ra-\/\+BLE-\/\+Sensor\hypertarget{md_README_autotoc_md1}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md1}
An n\+RF52 and SX1262 based Lo\+Ra\+WAN node that uses 2 configurable sensors, each with its own configurable power supply. The firmware for this node is built around the Zephyr RTOS. ZTEST and TWISTER are used for creating and running the unit tests for the device.\hypertarget{md_README_autotoc_md2}{}\doxysection{\texorpdfstring{Project Initialization}{Project Initialization}}\label{md_README_autotoc_md2}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md4}{}\doxysection{\texorpdfstring{Power Analysis}{Power Analysis}}\label{md_README_autotoc_md4}

\begin{DoxyItemize}
\item No power analysis is done yet
\end{DoxyItemize}\hypertarget{md_README_autotoc_md5}{}\doxysection{\texorpdfstring{Bugs/\+To-\/\+Do}{Bugs/To-Do}}\label{md_README_autotoc_md5}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md6}{}\doxysection{\texorpdfstring{Revision History}{Revision History}}\label{md_README_autotoc_md6}
Current Version\+: {\bfseries{V0.\+4.\+1}}

Version Breakdown\+: {\ttfamily \mbox{[}Major API Change\mbox{]}}.{\ttfamily \mbox{[}Minor Change/\+Added Functionality\mbox{]}}.{\ttfamily \mbox{[}Patch/bug fixes\mbox{]}}\hypertarget{md_README_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{V0.\+4.\+1}{V0.4.1}}\label{md_README_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md8}{}\doxysubsubsection{\texorpdfstring{V0.\+4.\+0}{V0.4.0}}\label{md_README_autotoc_md8}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{V0.\+3.\+0}{V0.3.0}}\label{md_README_autotoc_md9}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md10}{}\doxysubsubsection{\texorpdfstring{V0.\+2.\+2}{V0.2.2}}\label{md_README_autotoc_md10}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md11}{}\doxysubsubsection{\texorpdfstring{V0.\+2.\+1}{V0.2.1}}\label{md_README_autotoc_md11}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md12}{}\doxysubsubsection{\texorpdfstring{V0.\+2.\+0}{V0.2.0}}\label{md_README_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{V0.\+1.\+0}{V0.1.0}}\label{md_README_autotoc_md13}
