...
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{sensor__timer_8h_ab78c3218f2abf2dc92a6661c730f6c7d}{MINUTES\+\_\+\+TO\+\_\+\+SECONDS}}(minutes)~(minutes \texorpdfstring{$\ast$}{*} 60)
...
\index{sensor\_timer.h@{sensor\_timer.h}!MINUTES\_TO\_SECONDS@{MINUTES\_TO\_SECONDS}}
\index{MINUTES\_TO\_SECONDS@{MINUTES\_TO\_SECONDS}!sensor\_timer.h@{sensor\_timer.h}}
\doxysubsubsection{\texorpdfstring{MINUTES\_TO\_SECONDS}{MINUTES\_TO\_SECONDS}}
{\footnotesize\ttfamily \#define MINUTES\+\_\+\+TO\+\_\+\+SECONDS(\begin{DoxyParamCaption}\item[{}]{minutes }\end{DoxyParamCaption})~(minutes \texorpdfstring{$\ast$}{*} 60)}
